class App.TicketState extends App.Model
  ...
  @configure_attributes = [
    ...
    { name: 'state_type_id',        display: __('Type'),                tag: 'select',    null: false, relation: 'TicketStateType', nulloption: true, help: __('State types define how the system treats each state (pending, closed, reminders, etc.). See the Help Center for details.'), helpLink: ' <a href="/help" target="_blank">🔗</a>', translate: true },
