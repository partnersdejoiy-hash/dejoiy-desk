...
import type { EnumAfterAuthType, SessionAfterAuth } from '#shared/graphql/types.ts'
...
export const ensureAfterAuth = async (router: Router, afterAuth: SessionAfterAuth) => {
